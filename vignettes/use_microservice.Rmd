...
address <localhost> and `port` number <8080>
...
microservice at <http://localhost:8080/>. In particular, the function creates or
...
can browse OpenAPI at <http://localhost:8080//__docs__/>.
